...
//    self.statusLabel.frame = self.bounds;
    self.statusLabel.frame = CGRectMake(0, 0, [self.refreshingText widthWithFont:[UIFont boldSystemFontOfSize:13] withLineHight:self.frame.size.height], self.frame.size.height);
    self.statusLabel.center = CGPointMake((self.mj_width- [@"..."widthWithFont:[UIFont boldSystemFontOfSize:13] withLineHight:self.frame.size.height])/2, self.frame.size.height/2);
    
    self.statusDotLabel.frame = CGRectMake(CGRectGetMaxX(self.statusLabel.frame), CGRectGetMinY(self.statusLabel.frame), [@"..."widthWithFont:[UIFont boldSystemFontOfSize:13] withLineHight:self.frame.size.height], self.frame.size.height);
}
