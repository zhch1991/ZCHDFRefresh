...
#pragma mark - 内部的控件
@property (nonatomic, weak) UILabel *statusDotLabel;
@property (nonatomic, weak) UILabel *statusLabel;
@property (nonatomic, weak) UIImageView *arrowImage;
@property (nonatomic, weak) IconAnimationView *activityView;
//@property (nonatomic, weak) IconAnimationView *iconView;
#pragma mark - 回调
/**
 *  开始进入刷新状态的监听器
 */
...
@property (copy, nonatomic) NSString *refreshingDotText;
@end